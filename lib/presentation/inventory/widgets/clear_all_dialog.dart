...
import 'package:greezy/presentation/shared/extensions/media_query_extensions.dart';
...
class _ClearAllDialogState extends State<ClearAllDialog> {
  ...
  void _clearAll(BuildContext context) {
    if (_itemToClear == 'menu') {
      context.read<InventoryBloc>().add(const InventoryEvent.clearMenu());
    }
