...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  SettingsBloc(
    ...
    on<_IsProfileHeaderSetChanged>(_mapIsProfileHeaderSetToState);
  ...
  void _mapIsProfileHeaderSetToState(_IsProfileHeaderSetChanged event, Emitter<SettingsState> emit) {
    _settingsService.isProfileHeaderSet = event.newValue;
    emit(currentState.copyWith.call(isProfileHeaderSet: event.newValue));
  }
